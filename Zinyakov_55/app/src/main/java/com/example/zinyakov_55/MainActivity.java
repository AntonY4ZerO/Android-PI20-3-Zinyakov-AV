...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String WHERE_MY_CAT_ACTION = "com.example.zinyakov_55.action.CAT";
    ...
    public void sendMessage(View view) {
        ...
        intent.putExtra("com.example.zinyakov_55.broadcast.Message", "Сообщение отправлено");
